        ...
        <div className="space-y-8 lg:space-y-10 order-2 lg:order-1">
          ...
          <div>
            ...
            <p className="text-graphite text-lg md:text-xl leading-relaxed max-w-2xl">
              Contemporary French artist and sculptor behind the Orlinski universe. A global best‑seller
              known for faceted geometry, monumental scale, and accessible luxury.
            </p>
          </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative overflow-hidden rounded-3xl border border-black/10 shadow-[0_30px_80px_-60px_rgba(0,0,0,0.7)]">
          <div
            ...
            style={{
            backgroundImage: "url('/images/influence.jpg')",
        ...
        <div className="rounded-3xl border border-black/10 bg-offwhite/80 p-8 shadow-[0_30px_80px_-60px_rgba(0,0,0,0.7)]">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-black/10 bg-white p-5 shadow-[0_20px_50px_-40px_rgba(0,0,0,0.6)]">
              <p className="text-xs uppercase tracking-[0.25em] text-black/60">Age Profile</p>
              <p className="mt-2 font-heading text-3xl text-black">60% of audience is 35+</p>
              <p className="mt-2 text-sm text-graphite">A mature, decision‑maker audience.</p>
            </div>
          </div>
        </div>
      </section>
